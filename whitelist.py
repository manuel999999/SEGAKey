...
def whitelist_check(context, data):
    ...
    if username not in whitelist:
        ...
        context.send_crypto_packet(SystemMessagePacket("Oops sorry, you are not registered in the whitelist. If you are already registered before, doom might have missed your name from the last edit. Please contact doom or kasumi", 0x1).build())
